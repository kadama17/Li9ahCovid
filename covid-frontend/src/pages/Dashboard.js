          ...
          {this.state.role === "Logistique" ? (
            <div style={{ marginLeft: "20%" }}>
              <Row>
                ...
                <Col md={5} sm={6}>
                  <Card
                    style={{ marginTop: "30px", float: "left", width: "20rem" }}
                  >
          ...
          {this.state.role === "Admin" ? (
            <>
              <Row>
                <Col sm={2} md={3}>
                  ...
                  >
                    ...
                    <Card.Body>
                      ...
                      <Card.Text>
                        Créer un nouveau compte utilisateur pour le personnel
                        soignant de l'établissement sanitaire.
                      </Card.Text>
                ...
                <Col sm={2} md={3}>
                  ...
                  >
                    ...
                    <Card.Body>
                      ...
                      <Card.Text>
                        Vous pouvez modifier des informations sur les
                        utilisateur, les supprimer...
                      </Card.Text>
                ...
                <Col sm={2} md={3}>
                  <Card style={{ marginTop: "30px", width: "20rem" }}>
                    <Card.Img src="images/vaccin-list.png" />
                    <Card.Body>
                      <Card.Title>Liste de vaccin</Card.Title>
                      <Card.Text>
